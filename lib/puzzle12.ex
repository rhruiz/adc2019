defmodule Puzzle12 do
  ...
  def step(moons, positions, velocities) do
    new_velocities =
      ...
      |> Enum.reduce(velocities, fn {moon, effects}, velocities ->
        Map.update!(velocities, moon, fn velocity ->
  ...
  def gravity_effect(%Vector{} = a, %Vector{} = b) do
    ~w(x y z)a
  ...
  def gravity_effect(a, b) when a < b, do: {1, -1}
  def gravity_effect(a, a), do: {0, 0}
  def gravity_effect(_, _), do: {-1, 1}
